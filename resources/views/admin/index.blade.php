...
@section('main')
    <div class="container pt-3 ps-3">
        <div class="ps-3">
<h3 style="color:rgb(100, 9, 100); font-weight:bold"> Dashboard </h3>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card shadow rounded-5 order-card"
        ...
        <div class="card shadow rounded-5 order-card"
            ...
            <div class="card-body fw-bold text-dark">
                ...
                <div class="row  mt-3 shadow">
                    ...
                    <div class="col-12 col-lg-8 ">
                        <div class="bg-white rounded-4 shadow p-4">
                            <div class="d-flex justify-content-between align-items-center between mb-4">
                                <h2 class="text-xl font-semibold " style="color:rgb(100, 9, 100); font-weight:bold">Today's Bookings</h2>
                                <button class="btn text-primary ">View All</button>
                            </div>
                                @foreach ($bookings as $booking)
                            <div class="mb-3">
                                <div
                                    class="d-flex justify-content-between align-items-center  pt-3 px-3 border border-info rounded-4 ">
                                    <div class="d-flex  align-items-center gap-4">
                                        <div class="d-flex  gap-2">
                                            ...
                                            <span class="px-2 py-1 rounded-5 text-xs font-medium bg-info text-white">
                                                {{ ucfirst($booking->status) }} </span>
                                        </div>
                                        <div>
                                            <p class="font-medium text-dark">{{ ucfirst($booking->customerName) }}</p>
                                            <p class="text-sm text-dark">{{ ucfirst($booking->bikeBrand) }}
                                                {{ ucfirst($booking->bikeType) }} {{ ucfirst($booking->year) }}</p>
                                        </div>
                                    </div>
                    ...
                    <div class=" col-12 col-lg-3 pt-2 shadow">

                        <div class="bg-white rounded-4 mb-4 shadow-sm p-4">
                            <div class="row m-0">
                                <h3 style="color:rgb(100, 9, 100); font-weight:bold"> Quick Actions </h3>
